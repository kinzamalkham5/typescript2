...
//         console.log(error);
//     });
const asyncOutput = document.getElementById("output") as HTMLPreElement;
const asyncStatus = document.getElementById("status") as HTMLElement;
const chainBtn = document.getElementById("chainBtn") as HTMLButtonElement;
const allBtn = document.getElementById("allBtn") as HTMLButtonElement;
const settledBtn = document.getElementById("settledBtn") as HTMLButtonElement;
const raceBtn = document.getElementById("raceBtn") as HTMLButtonElement;
const asyncBtn = document.getElementById("asyncBtn") as HTMLButtonElement;
