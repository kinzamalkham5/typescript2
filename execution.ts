...
const creationBtn =
  document.getElementById("creationBtn") as HTMLButtonElement;

const executionBtn =
  document.getElementById("executionBtn") as HTMLButtonElement;

const resetBtn =
  document.getElementById("resetBtn") as HTMLButtonElement;


const phaseTitle =
  document.getElementById("phaseTitle") as HTMLElement;

const phaseDescription =
  document.getElementById("phaseDescription") as HTMLElement;

const aValue =
  document.getElementById("aValue") as HTMLElement;

const bValue =
  document.getElementById("bValue") as HTMLElement;

const cValue =
  document.getElementById("cValue") as HTMLElement;

const greetValue =
  document.getElementById("greetValue") as HTMLElement;

const tdzText =
  document.getElementById("tdzText") as HTMLElement;

const consoleBox =
  document.getElementById("console") as HTMLElement;


creationBtn.addEventListener("click", (): void => {
...
executionBtn.addEventListener("click", (): void => {
